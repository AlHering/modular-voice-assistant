...
from src_legacy.interfaces.endpoints.text_generation_endpoints import register_endpoints
from src_legacy.control.backend_controller import BackendController
