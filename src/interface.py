...
from src.voice_assistant import AVAILABLE_MODULES, SpeechRecorderModule, TranscriberModule, SynthesizerModule, LocalChatModule, Re
...
class VoiceAssistantInterface(object):
    ...
    def add_config(self,
        ...
        :param config: Config.
        :param validate: Flag for triggering validation.
        :return: Response.
        """
